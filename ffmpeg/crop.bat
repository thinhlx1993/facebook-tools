...
ffmpeg -i %1 -i "%SrcDir%\%rand%.mp3" -vf "[0:v]crop=in_w*0.86:in_h*0.86,scale=%width%:%height%,setpts=1/1.15*PTS" -af "[1:a]atempo=1.15" -map "0:0" -map "1:0" -crf 10 -shortest done/%1 -y