    ...
    while True:
        ...
        if scheduler:
            ...
            for browser in browsers:
                ...
                playbtn = check_exist("playbtn.PNG", confidence=0.75)
                if playbtn:
                    pyautogui.click(playbtn, duration=1)
                time.sleep(70)

                btns = ['share_btn_1.PNG', 'share_btn.PNG']
                share_x, share_y, idx = deciscion(btns)
                ...
                if post_btn:
                    ...
                    # pyautogui.click(relative_position(x=819, y=350))
                    title = get_title()
                    paste_text(title)
